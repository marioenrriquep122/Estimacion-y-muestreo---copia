    ...
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg p-6 mt-6 border border-gray-100">
      ...
      <div className="mb-8">
        <div className="relative h-16 w-full bg-gray-100 rounded-lg overflow-hidden shadow-inner">
          ...
          <div
            ...
            style={{ 
              left: `${(0 - (center - range * 2)) / (range * 4) * 100}%`, // Centrado en 0 para diferencia
            }}
          >
      ...
      <div className="bg-gray-50 p-4 rounded-lg shadow-inner">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col items-center">
            <span className="text-xs uppercase tracking-wide text-gray-500">Diferencia estimada</span>
            <span className="font-mono text-sm text-gray-800 mt-1">0</span>
          </div>
        </div>
      </div>
      <div className="mt-6 flex items-center justify-center space-x-8">
        ...
        <div className="flex items-center">
          ...
          <span className="text-sm text-gray-700">Diferencia nula</span>
        </div>
      </div>
    </div>
  );
