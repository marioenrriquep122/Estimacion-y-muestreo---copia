...
const Calculos = ({ 
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (pop1 && pop2) {
        const diffMean = pop1.mean - pop2.mean;
        const stdError = Math.sqrt((Math.pow(pop1.stdDev, 2) / pop1.sampleSize) + (Math.pow(pop2.stdDev, 2) / pop2.sampleSize));
              ...
              <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4">
                <div className="flex items-center justify-center">
                  ...
                  <div className="bg-blue-50 px-4 py-2 rounded-lg border border-blue-100">
                    <span className="text-lg font-mono font-bold text-blue-700">{result.type === 'twoPopulations' ? formatNumber(result.lower) : formatNumber(result.lower)}</span>
                  </div>
                  <span className="text-2xl text-gray-400 mx-2">,</span>
                  <div className="bg-blue-50 px-4 py-2 rounded-lg border border-blue-100">
                    <span className="text-lg font-mono font-bold text-blue-700">{result.type === 'twoPopulations' ? formatNumber(result.upper) : formatNumber(result.upper)}</span>
                  </div>
            ...
            {result.type === 'twoPopulations' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-xl border border-blue-100 shadow-sm">
                  ...
                  <div className="flex items-center">
                    <span className="text-2xl font-mono font-bold text-blue-600">{formatNumber(pop1.mean - pop2.mean)}</span>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-xl border border-blue-100 shadow-sm">
